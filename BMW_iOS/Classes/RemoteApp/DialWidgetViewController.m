...
-(void)setSpeed1:(double)mph {
	...
	dial1.transform = CGAffineTransformMakeRotation((((mph*(210.0/140.0))+75)*(M_PI/180)) - (M_PI));
}
    
-(void)setSpeed2:(double)mph {
    dial2.layer.anchorPoint = CGPointMake(0.5, 0.8);
	dial2.transform = CGAffineTransformMakeRotation((((mph*(210.0/140.0))+75)*(M_PI/180)) - (M_PI));
}

-(void)setSpeed3:(double)mph {
    dial3.layer.anchorPoint = CGPointMake(0.5, 0.8);
	dial3.transform = CGAffineTransformMakeRotation((((mph*(210.0/140.0))+75)*(M_PI/180)) - (M_PI));
}
